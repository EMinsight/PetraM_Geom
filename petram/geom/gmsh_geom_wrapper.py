...
class Geometry(object):
    ...
    def add_point(self, p, lcar=0.0):
        self.p = self.p + 1
        self.factory.addPoint(p[0], p[1], p[2], lcar, self.p)
        self._point[self.p] = p
    ...
    def add_plane_surface(self, *ll1):
        self.sl = self.sl+1      
        self.factory.addPlaneSurface(list(ll1), self.sl)
